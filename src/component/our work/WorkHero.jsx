...
import { projectCardData } from './PurposeDriven';
function WorkHero() {
  ...
  return (
    <div ref={containerRef} className='h-[60vh] cursor-pointer'>
      <div className="container">

        <div className='relative w-fit'>
          <h1 className='text-[128px] uppercase'>Work</h1>
          <span className='absolute top-15 -right-6'>({projectCardData.length *2})</span>
        </div>
